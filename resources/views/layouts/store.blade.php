        ...
        <div class="header_content d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="header_extra ml-auto d-flex flex-row align-items-center justify-content-start">
                ...
                <div class="info_languages has_children">
                    <div class="language_flag"><img src="{{URL::asset('assets/images/flag_1.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
                    ...
                    <ul>
                        <li><a href="#">
                                <div class="language_flag"><img src="{{URL::asset('assets/images/flag_2.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
                                <div class="dropdown_text">french</div>
                            </a></li>
                        <li><a href="#">
                                <div class="language_flag"><img src="{{URL::asset('assets/images/flag_3.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
                                <div class="dropdown_text">japanese</div>
                            </a></li>
                        <li><a href="#">
                                <div class="language_flag"><img src="{{URL::asset('assets/images/flag_4.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
                                <div class="dropdown_text">russian</div>
                            </a></li>
                        <li><a href="#">
                                <div class="language_flag"><img src="{{URL::asset('assets/images/flag_5.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
                ...
                <div class="owl-item">
                    ...
                    <div class="home_content_container">
                        <div class="home_content">
                            ...
                            <div class="button button_1 home_button trans_200"><a href="{{route('cart')}}">Shop NOW!</a></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 box_col">
                        <div class="box">
                            <div class="box_image"><img src="{{URL::asset('assets/images/box_1.jpg')}}" alt=""></div>
                    ...
                    <div class="col-lg-4 box_col">
                        <div class="box">
                            <div class="box_image"><img src="{{URL::asset('assets/images/box_2.jpg')}}" alt=""></div>
                    ...
                    <div class="col-lg-4 box_col">
                        <div class="box">
                            <div class="box_image"><img src="{{URL::asset('assets/images/box_3.jpg')}}" alt=""></div>
                    ...
                    <div class="col">
                        <div class="products_container grid">
                            ...
                            <div class="product grid-item hot">
                                <div class="product_inner">
                                    <div class="product_image">
                                        <img src="{{URL::asset('assets/images/product_1.jpg')}}" alt="">
                                        <div class="product_tag">hot</div>
                                    </div>
                                    <div class="product_content text-center">
                                        <div class="product_title"><a href="product.html">Product 1</a></div>
                                        <div class="product_price">$39.90</div>
                                        <div class="product_button ml-auto mr-auto trans_200"><a href="{{route('cart')}}">add to cart</a></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="product grid-item">
                                <div class="product_inner">
                                    <div class="product_image"><img src="{{URL::asset('assets/images/product_2.jpg')}}" alt=""></div>
                                    <div class="product_content text-center">
                                        <div class="product_title"><a href="product.html">Product 2</a></div>
                            ...
                            <div class="product grid-item sale">
                                <div class="product_inner">
                                    <div class="product_image">
                                        <img src="{{URL::asset('assets/images/product_3.jpg')}}" alt="">
                                        <div class="product_tag">sale</div>
                                    </div>
                                    <div class="product_content text-center">
                                        <div class="product_title"><a href="product.html">Product 3</a></div>
                            ...
                            <div class="product grid-item">
                                <div class="product_inner">
                                    <div class="product_image">
                                        <img src="{{URL::asset('assets/images/product_4.jpg')}}" alt="">
                                    </div>
                                    <div class="product_content text-center">
                                        <div class="product_title"><a href="product.html">Product 4</a></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-md-6 footer_col">
                            <div class="footer_about">
                                ...
                                <div class="cards">
                                    <ul class="d-flex flex-row align-items-center justify-content-start">
                                        <li><a href="#"><img src="{{URL::asset('assets/images/card_1.jpg')}}" alt=""></a></li>
                                        <li><a href="#"><img src="{{URL::asset('assets/images/card_2.jpg')}}" alt=""></a></li>
                                        <li><a href="#"><img src="{{URL::asset('assets/images/card_3.jpg')}}" alt=""></a></li>
                                        <li><a href="#"><img src="{{URL::asset('assets/images/card_4.jpg')}}" alt=""></a></li>
                                        <li><a href="#"><img src="{{URL::asset('assets/images/card_5.jpg')}}" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer_blog">
                                ...
                                <div class="footer_blog_container">
                                    ...
                                    <div class="footer_blog_item d-flex flex-row align-items-start justify-content-start">
                                        <div class="footer_blog_image"><a href="blog.html"><img src="{{URL::asset('assets/images/footer_blog_1.jpg')}}" alt=""></a></div>
                                    ...
                                    <!-- Blog Item -->
                                    <div class="footer_blog_item d-flex flex-row align-items-start justify-content-start">
                                        <div class="footer_blog_image"><a href="blog.html"><img src="{{URL::asset('assets/images/footer_blog_2.jpg')}}" alt=""></a></div>
                                        <div class="footer_blog_content">
